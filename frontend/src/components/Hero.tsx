      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-bento-accent text-black px-10 py-5 rounded-3xl text-sm font-black uppercase tracking-widest hover:scale-105 transition-transform flex items-center gap-3 shadow-[0_0_30px_rgba(0,240,255,0.2)]">
              Explore Platform
