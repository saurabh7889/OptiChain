    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-bento-border">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button className="bg-bento-accent text-black px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 transition-all flex items-center gap-2">
            Get Started
      ...
      {isOpen && (
        ...
        >
          ...
          <button className="bg-bento-accent text-black w-full py-4 rounded-xl text-sm font-black uppercase tracking-widest">
            Get Started
          </button>
        </motion.div>
      )}
